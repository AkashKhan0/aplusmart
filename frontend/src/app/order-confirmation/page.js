          ...
          <div className="bg-white border border-[#dddddd] p-4 rounded shadow-sm">
             ...
             <div className="w-full">
              <h1 className="text-xl font-medium text-[#2B2A29] my-5 flex items-start gap-2">
                <FaHandPointRight className="mt-1 text-red-600 w-5 h-5 min-w-5" />{" "}
                Please pay delivery fee for confirm your order. Use order ID in
                your reference.
              </h1>
              <div className="border p-4 rounded border-[#da2828] bg-[#e4e4e4]">
                <h1 className="text-lg font-semibold capitalize">
                we accept : <span>Bkash, </span>
                <span>Rocket, </span>
                <span>Nagad, </span> <span>Upay</span>{" "}
              </h1>
              ...
              <div className="flex items-center gap-1.5">
              <h2 className="text-xs font-semibold">Use Order ID as reference :</h2>
